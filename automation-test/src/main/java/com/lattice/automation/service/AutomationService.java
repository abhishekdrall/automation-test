...
public interface AutomationService {
    ResponseEntity<?> automateProjectFile(final MultipartFile multipartFile) throws IOException, GenericException;
    ...
    File runProjectFile(final File destinationProjectDir) throws IOException;
}
